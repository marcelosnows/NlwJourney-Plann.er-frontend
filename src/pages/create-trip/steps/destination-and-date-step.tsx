...
interface DestinationAndDateStepProps {
  ...
  setEventStartEndDates: (date: DateRange | undefined) => void
};
...
export function DestinationAndDateStep({
  ...
  const displayedDate = eventStartEndDates && eventStartEndDates.from && eventStartEndDates.to
    ? formatDate(eventStartEndDates.from, "d 'de 'LLL").concat(' até ').concat(formatDate(eventStartEndDates.to, "d 'de 'LLL")) 
    : null;
